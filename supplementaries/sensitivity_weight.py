""" 
This version is for a sensitivity analysis of different weighting functions
"""
...
for label, f in [('unweighted', unweighted), ('idw2', idw2)]:
    ...
    if OUTPUT:
        ...
        with rio_open(f'../sensitivity/{label}.tif', 'w', driver='GTiff',
