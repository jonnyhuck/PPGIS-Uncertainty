...
# flatten grid points and query kdtree for ID of all points within radius of each location
...
# do some piggin' transformations
scores[6] = scores[0] + (scores[2] / 2)
scores[7] = scores[1] + (scores[3] / 2)
